...
namespace BakeAndTake.Context
{
    public class DbInitializer
    {
        ...
        {
            BakeAndTakeDbContext context = applicationBuilder
                .ApplicationServices
                .CreateScope()
                .ServiceProvider
                .GetRequiredService<BakeAndTakeDbContext>();
            ...
            if (!context.Pies.Any())
            {
                ...
                (
                    ...
                    { 
                        ...
                        InStock = false, 
                        IsPieOfTheWeek = false, ImageThumbnailUrl = "https://gillcleerenpluralsight.blob.core.windows.net/files/peachpiesmall.jpg", 
                        AllergyInformation = "" 
                    },
                    new Pie 
                    { 
